...
import com.examw.netplatform.dao.admin.settings.ICatalogDao;
...
public class CatalogDaoImpl extends BaseDaoImpl<Catalog> implements ICatalogDao {
	/*
	 * 查询数据。
	 * @see com.examw.netplatform.dao.admin.settings.ICatalogDao#findCatalogs(com.examw.netplatform.model.admin.settings.CatalogInfo)
	 */
	@Override
	...
	/*
	 * 查询数据统计。
	 * @see com.examw.netplatform.dao.admin.settings.ICatalogDao#total(com.examw.netplatform.model.admin.settings.CatalogInfo)
	 */
	@Override
